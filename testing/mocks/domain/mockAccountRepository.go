...
// Source: github.com/sMARCHz/rest-based-microservices-go/testing/domain (interfaces: AccountRepository)
...
import (
	...
	domain "github.com/sMARCHz/rest-based-microservices-go/testing/domain"
...
func (m *MockAccountRepository) SaveTransaction(arg0 domain.Transaction) (*domain.Transaction, *float64, *errs.AppError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveTransaction", arg0)
	ret0, _ := ret[0].(*domain.Transaction)
	ret1, _ := ret[1].(*float64)
	ret2, _ := ret[2].(*errs.AppError)
